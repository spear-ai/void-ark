...
The other directories are all generated by panamax within the docker-compose provided. Make sure to have the panamaxrs/panamax container installed if you are doing this offline.
...
- Make sure that your mounting the correct directory, this can be edited in the docker-compose file, if it doesnt exist one will be made for you
